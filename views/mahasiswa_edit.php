...
<body>
            ...
            <div class="col-12 col-md-8 col-lg-6">
                <div class="main-container">
                    ...
                    <div class="header-section">
                        ...
                        <p class="header-subtitle">Perbarui data mahasiswa</p>
                    </div>

                    <!-- Student Info -->
                    <div class="student-info">
                        <i class="fas fa-user-graduate fa-2x mb-2"></i>
                        <h5 class="mb-1">Mengedit Data:</h5>
                        <p class="mb-0"><?= htmlspecialchars($data['nama']); ?> (<?= htmlspecialchars($data['nim']); ?>)</p>
                    </div>

                    <!-- Form Container -->
                    <div class="form-container">
                        <form method="POST" id="mahasiswaEditForm">
                            <!-- NIM Field -->
    ...
    <script>
        ...
        document.getElementById('mahasiswaEditForm').addEventListener('submit', function(e) {
            ...
            // Confirm update
            if (!confirm('Apakah Anda yakin ingin memperbarui data mahasiswa ini?')) {
                e.preventDefault();
                return false;
            }
        ...
        ['nim', 'nama', 'jurusan'].forEach(field => {
